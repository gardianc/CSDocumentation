...
\textbf{Incertidumbre por ajuste de la corrección del patrón} ($\sigma_{\textit{int ccr pat}}$)
...
\textbf{Incertidumbre por ajuste de la incertidumbre de calibración del patrón} ($\sigma_{\textit{int cal pat}}$)
