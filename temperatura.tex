...
Fenómeno que produce una diferencia en las lecturas de un instrumento de medición dependiendo de si el valor fue alcanzado en forma ascendente o descendente. Su distribución de probabilidad de prgien es rectangular de ancho completo. Se aplica uno de dos criterios:
...
\textit{Criterio 2}: Se registran mediciones en el punto medio del rango durante las carreras ascendente y descendiente. La histéresis es la diferencia entre los promedios de ambas series\cite{DKD8.10}:
