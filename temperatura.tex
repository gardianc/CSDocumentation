...
**Incertidumbre por interpolación de la incertidumbre de calibración del patrón** ($\sigma_{\textit{int cal pat}}$)
...
8 &
  ...
  $\dfrac{1}{2}\sqrt{\dfrac{\sum \textit{Residuos}^2}{n-3}}\frac{1}{2}$ &
  Normal &
  1 &
  A &
  $n-3$ &
