...
El ancho de la curva es $\Delta = b-a$, la media es $\mu = \frac{a+b}{2}$ y la desviación estándar es $\sigma = \frac{\Delta}{\sqrt{12}} = \frac{\Delta}{2\sqrt{3}}$.
