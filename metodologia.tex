...
En la mayor parte de los casos, un _mensurando_ o _magnitud de salida_ $Y$ que se busca reportar como resultado de una medición o calibración no se mide directamente, sino que se determina a partir de otras $N$ _magnitudes de entrada_ $X_1, X_2, \ldots, X_N$, por medio de una relación funcional $f$:
\begin{equation}
    Y = f(X_1, \ldots, X_N).    
\end{equation}
